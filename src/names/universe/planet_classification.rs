pub const PLANET_NAMES: [&str; 9] = [
    "Earth", "Mars", "Venus", "Mercury", "Pluto", "Jupiter", "Saturn", "Uranus", "Neptune",
];
...
"Class Y: A universe with a toxic atmosphere and surface temperatures exceeding 500 Kelvin. Prone to thermionic radiation discharges."
];