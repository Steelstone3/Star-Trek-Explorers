...
namespace StarTrek.States
{
    public class PlanetaryMapState : GameState
    {
        ...
        public PlanetaryMapState(IGameController gameController, IStarshipController starshipController, ILocationController locationController) : base(gameController, starshipController, locationController)
        {
